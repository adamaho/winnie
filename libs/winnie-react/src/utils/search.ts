...
/**
 * Fully copied from https://github.com/pacocoursey/cmdk/blob/main/cmdk/src/command-score.ts
 *
 * All credits go the the creators of cmdk for this search algorithm.
 */
